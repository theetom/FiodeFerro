...
/*   Updated: 2024/06/27 14:36:15 by toferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fdf.h"

void x_line(int n, int **numbers, double xx, double yy, count_data *count_values)
{
	double		xx1;
	double		yy1;
	double		a;
...
void y_line(int n, int **numbers, double xx, double yy, count_data *count_values)
{
	double		xx1;
	double		yy1;
	double		a;
...
void two_to_three(int **numbers, count_data *count_values)
{
	int		n;
	double	xx;
	double	yy;
