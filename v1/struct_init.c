...
/*   Updated: 2024/08/30 16:32:44 by toferrei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// #include "fdf.h"

// double	two_d_cos(t_data *data, int n)
// {
// 	return ((data->tdp[n][0]) * cos(120) + (data->tdp[n][1]) * cos(120 + 2) + (data->tdp[n][2]) * cos(120 - 2));
// }

// double	two_d_sin(t_data *data, int n)
// {
...
// 			data->y_min = two_d_sin(data, n);
// 	}
// 	data->scale = 70 / (((data->y_max - data->y_min) * 100) / data->img_w);
// 	data->position_w = data->img_w / 2 - ((((data->x_max + data->x_min) * data->scale) / 2));
// 	data->position_h = data->img_h / 2 - ((((data->y_max + data->y_min) * data->scale) / 2));
// }
